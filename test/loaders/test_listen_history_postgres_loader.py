...
def sample_data():
    ...
    return [
        {"user_id": 1, "track_id": 100, "updated_at": "2024-03-20T10:00:00"},
        {"user_id": 2, "track_id": 200, "updated_at": "2024-03-20T11:00:00"},
    ]
...
class TestListenHistoryPostgresLoader:
    ...
    def test_delete_existing_records(
        self, mock_execute_values, loader, sample_data, mock_db
    ):
